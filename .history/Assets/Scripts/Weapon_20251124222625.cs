...
void Update()
{
    ...
    if (cameraRecoilTarget != null)
    {
        ...
        // 🚨 JAVÍTÁS: Lerp helyett MoveTowards-ot használunk, és reseteljük.
        recoilTarget = Vector3.MoveTowards(recoilTarget, Vector3.zero, Time.deltaTime * recoilReturnSpeed);
        
        // 🚨 ÚJ SOR: Ha nagyon közel vagyunk a nullához (szinte megálltunk), reseteljük.
        if (recoilTarget.magnitude < 0.01f)
        {
