...
public class Weapon : MonoBehaviour
{
    ...
    private Vector3 currentRecoil = Vector3.zero; // A kamera aktuális, animált eltolása
    private Vector3 recoilTarget = Vector3.zero;  // A cél eltolás, ahova a rángatásnak kell mennie
    ...
    void Start()
    {
        ...
        // 🚨 JAVÍTÁS (1.): Biztosítjuk, hogy a Recoil Target alapból 0 legyen.
    ...
    void Update()
    {
        ...
        if (cameraRecoilTarget != null)
        {
            ...
            // 🚨 JAVÍTÁS (2.): A recoil hatást a kamera aktuális lokális forgásához adjuk hozzá.
            // Ez a legfontosabb lépés az ugrálás ellen.
            ...
            // 4. Reset: Ha a célpont szinte nulla, állítsuk le teljesen a mozgást.
            if (recoilTarget.magnitude < 0.001f)
            {
                recoilTarget = Vector3.zero;
                currentRecoil = Vector3.zero;
                // Nem térünk vissza! Hagyjuk, hogy a MouseLook felülírja a frame-ben.
            }
        }
    }
    ...
    void DoRecoil()
    {
        ...
        recoilTarget += new Vector3(
            // 🚨 JAVÍTÁS (3.): Szélesebb oldalirányú rángás (pl. 40%)
            Random.Range(-recoilAmount * 0.4f, recoilAmount * 0.4f), 
