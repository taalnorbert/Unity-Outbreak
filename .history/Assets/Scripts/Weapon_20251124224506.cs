...
public class Weapon : MonoBehaviour
{
    ...
    public float recoilRecoverySpeed = 5f; // Mennyire gyorsan tér vissza

    private float currentRecoil = 0f; // Az aktuális recoil értéke
    private float recoilVelocity = 0f; // Simításhoz használt velocity
    ...
    void DoRecoil()
    {
        // Egyszerű additive recoil - csak növeljük az értéket
        currentRecoil += recoilAmount;
    }
    
    // Getter a recoil értékhez - ezt használja a MouseLook script!
