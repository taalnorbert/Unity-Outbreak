...
void Die()
{
    ...
    // Átmenet a 'Dead' animációra (ha van)
    if (anim != null)
    {
    ...
    // 2. Halál hang lejátszása és elpusztítás kezelése
    if (deathSoundSource != null && deathSoundSource.clip != null)
    {
        deathSoundSource.Play();
        
        // Elpusztítás késleltetése a hang hossza után
        // FIGYELEM: Ha a hang nagyon rövid (0.1 mp), ez működik. 
        // Ha nem tűnik el, növeld a Destroy időt!
        Destroy(gameObject, deathSoundSource.clip.length + 0.1f); 
    } 
    else 
    {
