...
public class ZombieAI : MonoBehaviour, IDamageable
{
    ...
    void Die()
    {
        ...
        if (anim != null)
        {
            // 🚨 EZ AZ ÚJ SOR: SetTrigger a SetBool helyett
            anim.SetTrigger("IsDead"); 
            Debug.Log("Animáció: IsDead Trigger beállítva."); 
        }
        else
        {
            // Hibajelzés, ha hiányzik az animátor
    ...
    private void OnAnimatorMove()
    {
        ...
        {
            transform.position = anim.rootPosition; // Visszaállítjuk a root motiont, ha az agent nincs engedélyezve
